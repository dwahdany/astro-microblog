...
There are probably more eloquent ways this has been formulated, but this is how I remember [**Shengchao Liu**](https://chao1224.github.io/) has put it during a talk about multi-modal foundation models at AAAI25, and it got me thinking. Obviously, it's a bit (or lot) of a hyperbole, but I think the intuition still stands:
...
![](simple-ideas/2025-02-image.png)
...
If you're driven and motivated (and a supportive environment helps here), then you will eventually find a way. To give another example from [Henrik Karlsson](https://substack.com/@henrikkarlsson/note/c-95868620).
