---
slug: why-i-pay-for-search
title: "Why I Pay for Search"
created: 2025-08-09T17:10:49+00:00
tags: [ai, social]
is_draft: false
---

I think Google as a company is doing great, and I do support many of the things they do. But search isn't one of them. Here are a couple of reasons why I prefer using [**Kagi**](https://kagi.com/), a **paid search engine**. So much so that I have invested in the company in their second round.
...
![](why-i-pay-for-search/2025-08-Pasted-image-20250806002706.png)
...
![](why-i-pay-for-search/2025-08-Pasted-image-20250805235729.png)
...
![](why-i-pay-for-search/2025-08-Pasted-image-20250805235257.png)
...
Aweful and useless sites like the Apple discussions forum can be downranked or, as they should, completely blocked from your results. Some stats: The [most-blocked websites](https://kagi.com/stats?stat=leaderboard&k=-2) are pinterest, foxnews and tiktok. The [most-pinned websites](https://kagi.com/stats?stat=leaderboard&k=2) are wikipedia, the mozilla developer website and reddit.

### Integrated features

Summarize, open in webArchive or ask an LLM right from search.

![](why-i-pay-for-search/2025-08-Pasted-image-20250805235852.png)
...
![](why-i-pay-for-search/2025-08-Pasted-image-20250805235939.png)
...
![](why-i-pay-for-search/2025-08-Pasted-image-20250806000109.png)
...
![](why-i-pay-for-search/2025-08-Pasted-image-20250806000440.png)
...
![](why-i-pay-for-search/2025-08-grafik-1.png)
...
![](why-i-pay-for-search/2025-08-Pasted-image-20250806000629.png)![](why-i-pay-for-search/2025-08-Pasted-image-20250806000645.png)
...
![](why-i-pay-for-search/2025-08-Pasted-image-20250806001512-1.png)
...
![](why-i-pay-for-search/2025-08-Pasted-image-20250806002501.png)

A page with many trackers will have a warning symbol on the right.

Such pages are also downranked automatically.

![](why-i-pay-for-search/2025-08-Pasted-image-20250806002518.png)

Kagi shows the number of trackers and which trackers are present on the website.

Kagi is paid, so you do need to authenticate for every query. But you can still use it without tying a query (which is not logged anyway) to your account. The technology behind that is based on RFC-standardized privacy passes. Here is [their blog post](https://blog.kagi.com/kagi-privacy-pass). Essentially it lets you generate anonymous tokens, each of which can be used for one search query. There is a browser extension that handles this process automatically.

![](why-i-pay-for-search/2025-08-Pasted-image-20250806001719.png)
...
Kagi is a public benefit corporation since 2024. [Their statement](https://blog.kagi.com/what-is-next-for-kagi#4) says:
...
[Stats](https://kagi.com/stats)! Check out how many (paying) users they have or how many queries are performed each day.

![](why-i-pay-for-search/2025-08-Pasted-image-20250806002121.png)

The number of users, all of whom pay.

![](why-i-pay-for-search/2025-08-Pasted-image-20250806002129.png)
...
![](why-i-pay-for-search/2025-08-Pasted-image-20250806002225.png)
...
disclaimer: I am an investor in kagiI think Google as a company is doing great, and I do support many of the things they do. But search isn't one of them. Here are a couple of reasons why I prefer using [Kagi](https://kagi.com/), a ****paid search engine.**** So much so that I have invested in the company in their second round.
